...
- **HTTPS**: Se genera una muestra del dataset HTTPS con los parámetros nrows=3000(total de filas posibles a mostrar) y scope=3000(total de filas mostradas). Dichos parámetros pueden modificarse para generar dataframes con diferentes valores, siempre que se respete la siguiente condición (nrows<scope).
...
#### **Se añade Pais**
Se procesa la longitud y latitud de la IP origen y devuelve el pais asociado. 
```{r}
...
#### **Barplot**
Se filtran los datos para obtener la cantidad de conexiones por pais y seguidamente se muestran con un barplot.
...
#### **WorldMap**
Se filtran los datos para obtener la cantidad de conexiones por pais y seguidamente se muestran en un mapa mundo.
